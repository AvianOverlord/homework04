...
function checkAnswer()
{
    ...
    if(!(answerIndex===0 || answerIndex===1 || answerIndex===2 || answerIndex===3 )) //Prevents the code from registering clicking the margins as a wrong answer. Crude, but works.
    {
        return;
    }
